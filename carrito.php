    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="./"><h3>UDENAR SHOP</h3></a>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row">
                ...
                <div class="col-md-5 ms-auto">
                    <h4>Total a Pagar:<span id="">$</span> <span id="total_pagar">0.00</span><span id="cop">COP</span></h4>
                    <div class="d-grid gap-2">
                        <div id="paypal-button-container"></div>
                        <button class="btn btn-warning" type="button" id="btnVaciar">Sacar Productos</button>
                    </div>
                </div>
            </div>
        </div>
