...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" id="abrirProducto"><i class="fas fa-plus fa-sm text-white-50"></i> Agregar</a>
</div>
<div class="row">
    <div class="col-md-12">
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="p_rebajado">Precio con Descuento</label>
                                <input id="p_rebajado" class="form-control" type="text" name="p_rebajado" placeholder="Precio con Descuento" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
